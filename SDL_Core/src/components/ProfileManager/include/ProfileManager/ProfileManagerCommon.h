...
/**
 * @brief The ProfileState enum provides possible profile states
 */
enum ProfileState
{
	PROFILE_STATE_FOREGROUND,
	PROFILE_STATE_LIMITED,
	PROFILE_STATE_BACKGROUND,
};

/**
 * @brief The MobileAppState enum provides possible mobile app states
 */
enum MobileAppState
{
	MOBILE_APP_FOREGROUND,
	MOBILE_APP_BACKGROUND,
	MOBILE_APP_LOCK_SCREEN,
};
...
enum MessageTypes
{
    ...
    MSG_TYPE_HMI_RESPONSE,
    MSG_TYPE_HMI_NOTIFICATION,
    MSG_TYPE_MOBILE_APP_EXITED,
    MSG_TYPE_HMI_NOTIFICATION_IVILINK,
    
    // messages from profile process to PM
    MSG_TYPE_PROFILE_STATE_CHANGED = PROFILE_TO_PROFILE_MANAGER_INITIAL_ID,
    MSG_TYPE_PROFILE_STATE_CHANGED_BROADCAST,
    MSG_TYPE_HMI_REQUEST,
    MSG_TYPE_PROFILE_TO_APP_MESSAGE,
