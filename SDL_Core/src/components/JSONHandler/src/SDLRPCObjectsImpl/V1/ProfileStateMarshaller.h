#ifndef NSSMARTDEVICELINKRPC_PROFILESTATEMARSHALLER_INCLUDE
#define NSSMARTDEVICELINKRPC_PROFILESTATEMARSHALLER_INCLUDE
...
#include "../include/JSONHandler/SDLRPCObjects/V1/ProfileState.h"
...
//! marshalling class for ProfileState
  ...
  public:
    ...
    static bool checkIntegrity(ProfileState& e)		{ return e.mInternal!=ProfileState::INVALID_ENUM; } 
    static bool checkIntegrityConst(const ProfileState& e)	{ return e.mInternal!=ProfileState::INVALID_ENUM; } 
