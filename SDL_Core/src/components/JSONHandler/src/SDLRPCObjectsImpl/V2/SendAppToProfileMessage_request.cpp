...
SendAppToProfileMessage_request& SendAppToProfileMessage_request::operator =(
    const SendAppToProfileMessage_request& c)
{
...
SendAppToProfileMessage_request::SendAppToProfileMessage_request(
    const SendAppToProfileMessage_request& c)
{
  *this=c;
}
