...
SendAppToProfileMessage_response& SendAppToProfileMessage_response::operator =(
    const SendAppToProfileMessage_response& c)
{
...
SendAppToProfileMessage_response::SendAppToProfileMessage_response(
    const SendAppToProfileMessage_response& c)
{
  *this=c;
}
