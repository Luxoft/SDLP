#ifndef NSSMARTDEVICELINKRPCV2_ACTIONPERFORMERMARSHALLER_INCLUDE
#define NSSMARTDEVICELINKRPCV2_ACTIONPERFORMERMARSHALLER_INCLUDE
...
#include "../include/JSONHandler/SDLRPCObjects/V2/ActionPerformer.h"
...
//! marshalling class for ActionPerformer
  ...
  public:
    ...
    static bool checkIntegrity(ActionPerformer& e)
    {
      return e.mInternal!=ActionPerformer::INVALID_ENUM;
    } 
    static bool checkIntegrityConst(const ActionPerformer& e)
    {
      return e.mInternal!=ActionPerformer::INVALID_ENUM;
    } 
