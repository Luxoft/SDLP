#ifndef NSSMARTDEVICELINKRPCV2_LOADPROFILE_REQUEST_INCLUDE
#define NSSMARTDEVICELINKRPCV2_LOADPROFILE_REQUEST_INCLUDE
...
///  Requests head unit to load profile.
  ...
  class LoadProfile_request : public NsSmartDeviceLinkRPC::SDLRPCRequest
  {
  public:
