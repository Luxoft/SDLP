#ifndef NSSMARTDEVICELINKRPCV2_SENDAPPTOPROFILEMESSAGE_REQUEST_INCLUDE
#define NSSMARTDEVICELINKRPCV2_SENDAPPTOPROFILEMESSAGE_REQUEST_INCLUDE
...
///  Sends message from mobile application into profile on head unit.
  ...
  class SendAppToProfileMessage_request : public NsSmartDeviceLinkRPC::SDLRPCRequest
  {
  public:
