#ifndef NSSMARTDEVICELINKRPCV2_ONPROFILEUNLOADED_INCLUDE
#define NSSMARTDEVICELINKRPCV2_ONPROFILEUNLOADED_INCLUDE
...
///  Notifies mobile application that profile was unloaded by SDL.
  ...
  class OnProfileUnloaded : public NsSmartDeviceLinkRPC::SDLRPCNotification
  {
  public:
