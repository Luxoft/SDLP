#ifndef NSSMARTDEVICELINKRPCV2_UNLOADPROFILE_REQUEST_INCLUDE
#define NSSMARTDEVICELINKRPCV2_UNLOADPROFILE_REQUEST_INCLUDE
...
///  Requests head unit to unload running profile.
  ...
  class UnloadProfile_request : public NsSmartDeviceLinkRPC::SDLRPCRequest
  {
  public:
