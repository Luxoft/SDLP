#ifndef NSSMARTDEVICELINKRPCV2_REMOVEPROFILE_REQUEST_INCLUDE
#define NSSMARTDEVICELINKRPCV2_REMOVEPROFILE_REQUEST_INCLUDE
...
///  Requests SDL to remove profile from head unit.
  ...
  class RemoveProfile_request : public NsSmartDeviceLinkRPC::SDLRPCRequest
  {
  public:
