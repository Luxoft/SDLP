#ifndef NSSMARTDEVICELINKRPC_ADDPROFILE_RESPONSE_INCLUDE
#define NSSMARTDEVICELINKRPC_ADDPROFILE_RESPONSE_INCLUDE
...
namespace NsSmartDeviceLinkRPC
{
  ...
  class AddProfile_response : public SDLRPCResponse
  {
  public:
