#ifndef NSSMARTDEVICELINKRPC_REMOVEPROFILE_RESPONSE_INCLUDE
#define NSSMARTDEVICELINKRPC_REMOVEPROFILE_RESPONSE_INCLUDE
...
namespace NsSmartDeviceLinkRPC
{
  ...
  class RemoveProfile_response : public SDLRPCResponse
  {
  public:
