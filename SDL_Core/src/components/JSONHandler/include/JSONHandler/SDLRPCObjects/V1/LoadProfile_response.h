#ifndef NSSMARTDEVICELINKRPC_LOADPROFILE_RESPONSE_INCLUDE
#define NSSMARTDEVICELINKRPC_LOADPROFILE_RESPONSE_INCLUDE
...
namespace NsSmartDeviceLinkRPC
{
  ...
  class LoadProfile_response : public SDLRPCResponse
  {
  public:
