#ifndef NSSMARTDEVICELINKRPC_SENDAPPTOPROFILEMESSAGE_RESPONSE_INCLUDE
#define NSSMARTDEVICELINKRPC_SENDAPPTOPROFILEMESSAGE_RESPONSE_INCLUDE
...
namespace NsSmartDeviceLinkRPC
{
  ...
  class SendAppToProfileMessage_response : public SDLRPCResponse
  {
  public:
