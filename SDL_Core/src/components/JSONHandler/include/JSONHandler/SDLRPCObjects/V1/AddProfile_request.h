#ifndef NSSMARTDEVICELINKRPC_ADDPROFILE_REQUEST_INCLUDE
#define NSSMARTDEVICELINKRPC_ADDPROFILE_REQUEST_INCLUDE
...
///  Sends message from app into profile.
  ...
  class AddProfile_request : public SDLRPCRequest
  {
  public:
