#ifndef NSSMARTDEVICELINKRPC_ONPROFILESTATECHANGED_INCLUDE
#define NSSMARTDEVICELINKRPC_ONPROFILESTATECHANGED_INCLUDE
...
///  Notifies mobile application that profile state was changed
  ...
  class OnProfileStateChanged : public SDLRPCNotification
  {
  public:
