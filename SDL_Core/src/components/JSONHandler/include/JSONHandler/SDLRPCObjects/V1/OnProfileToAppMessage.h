#ifndef NSSMARTDEVICELINKRPC_ONPROFILETOAPPMESSAGE_INCLUDE
#define NSSMARTDEVICELINKRPC_ONPROFILETOAPPMESSAGE_INCLUDE
...
///  Sends message from profile to mobile application.
  ...
  class OnProfileToAppMessage : public SDLRPCNotification
  {
  public:
