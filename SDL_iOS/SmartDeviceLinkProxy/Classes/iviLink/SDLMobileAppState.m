...
+(NSMutableArray*) values {
    if (SDLMobileAppState_values == nil) {
...
+(SDLMobileAppState*) MOBILE_APP_FOREGROUND {
    if (SDLMobileAppState_MOBILE_APP_FOREGROUND == nil) {
...
+(SDLMobileAppState*) MOBILE_APP_BACKGROUND {
    if (SDLMobileAppState_MOBILE_APP_BACKGROUND == nil) {
...
+(SDLMobileAppState*) MOBILE_APP_LOCK_SCREEN {
    if (SDLMobileAppState_MOBILE_APP_LOCK_SCREEN == nil) {
