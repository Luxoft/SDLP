...
#define IVI_NAMES_onProfileStateChanged @"OnProfileStateChanged"


// JSON TAGS
#define IVI_NAMES_TAG_profileBinary @"profileBinary"
#define IVI_NAMES_TAG_profileName @"name"
#define IVI_NAMES_TAG_mobileAppState @"state"
#define IVI_NAMES_TAG_msgToProfile @"profileData"
#define IVI_NAMES_TAG_msgFromProfile @"data"
#define IVI_NAMES_TAG_profileState @"state"
