...
public class RPCRequestFactory {
	...
	public static RegisterAppInterface buildRegisterAppInterface(
		...
		if (SyncMsgVersion == null) {
			...
			SyncMsgVersion.setMajorVersion(Integer.valueOf(SMARTDEVICELINK_MSG_MAJOR_VERSION));
			SyncMsgVersion.setMinorVersion(Integer.valueOf(SMARTDEVICELINK_MSG_MINOR_VERSION));
		} 
