...
public class Names {
	...
	// Profile management	
	public static final String addProfile = "AddProfile";
	public static final String removeProfile = "RemoveProfile";
	public static final String loadProfile = "LoadProfile";
	public static final String unloadProfile = "UnloadProfile";
	public static final String sendAppToProfileMessage = "SendAppToProfileMessage";
	public static final String appStateChanged = "AppStateChanged";
	
	public static final String onProfileClosed = "OnProfileUnloaded";
	public static final String onProfileStateChanged = "OnProfileStateChanged";
	public static final String onReceiveMessageFromProfile = "OnProfileToAppMessage";
}
