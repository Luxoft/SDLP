...
public abstract class SmartDeviceLinkProxyBase<proxyListenerType extends IProxyListenerBase> {
	...
	private void handleRPCMessage(Hashtable hash) {
		...
		if (messageType.equals(Names.response)) {			
            ...
            } else if (functionName.equals(Names.onProfileStateChanged)) {
                final OnProfileStateChanged notification = new OnProfileStateChanged(hash);
                mProfileManagerCallbacksProxy.onProfileStateChanged(notification);
