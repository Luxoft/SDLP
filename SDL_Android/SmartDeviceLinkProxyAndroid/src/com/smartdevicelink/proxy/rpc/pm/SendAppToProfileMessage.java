...
public class SendAppToProfileMessage extends RPCProfileManagerRequest {
    ...
    public byte[] getMessage() {
        return RPCProfileManagerHelper.getBytesForKeyFrom64String(parameters, HashTableKeys.MSG_APP_TO_PROFILE);
    }

    public void setMessage(byte[] message) {
        RPCProfileManagerHelper.setBytesForKeyAs64String(parameters, HashTableKeys.MSG_APP_TO_PROFILE, message);
    }
}
